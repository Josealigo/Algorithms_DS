    ...
    dashboardBody(
        tabItems(
            ...
            tabItem("GD_1",
                    ...
                    h3('The first solution is given by a closed function, wich gives the data aside.'),
            ...
            tabItem("GD_2",
                    ...
                    box(column(plotOutput("plot1_GD2", click = "plot_click",width = "150%",height = "400px"),
                        ...
                        column(textInput("GD_2_SS", "Step size","0.001"),
                               ...
                               h4("After training with various values, it was found that before 0.0004 the convergence is slower and after 0.0005 it is also slower until the divergence, so the best value of those tried was 0.00045."), status = "primary", 
                               title = "O",  width = 6 , height = 120)
                    ),
            ...
            tabItem("GD_3",
                    ...
                    tableOutput("GD_3_Error_Output"),
                    tableOutput("GD_3_Sol_Output")),
            
            tabItem("GD_4",
                    h1("Mini Batch Gradient Descent Solution on Linear Regression"),
                    h3(''),
                    actionButton("GD_4_Sol", "Get Solution"),
                    tableOutput("GD_4_Error_Output"),
                    tableOutput("GD_4_Sol_Output")),
